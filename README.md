...
## Human Evaluation
To assess the naturalness and semantic consistency of generated adversarial samples, we conducted a human evaluation study.
The full questionnaire, instructions, and evaluation interface are provided in the **`human_evaluation/`** folder, including all rating sheets used by participants.
