...
The second script, get_adv_set.py, generates adversarial test sets (samples indexed from 500–999), which contain only the successfully attacked samples for each tool and model.
