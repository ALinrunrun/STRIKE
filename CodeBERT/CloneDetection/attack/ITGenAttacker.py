...
class ITGen_Attacker(object):
    ...
    def itgen_attack(self, example, substitutes, code, query_times, logits, example_start_time):
        ...
        while self.BLOCK_QUEUE:
            ...
            # print(opt_indices, fix_indices, stage_init_ind, stage_iter, ex_ball_size, n_samples, next_len, cont)
            if cont: continue
        ...
        if is_success == 1:
            ...
            # print(self.adv_code(code_1, new_code_tokens))
            return None, 0, None 
