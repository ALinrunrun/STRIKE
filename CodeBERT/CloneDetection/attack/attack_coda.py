...
from codaAttacker import Coda_Attacker
        ...
        if is_success >= -1:
            ...
            if is_success >= 1:
                ...
                if is_success == 1:
                    ...
                    suc_label = "struct"
                recoder.write(index, first_code, final_code, len(orig_code_tokens),  min_gap_prob,
                          None, model.query - query_times, example_end_time, suc_label)
            else:
                recoder.write(index, first_code, final_code, len(orig_code_tokens),  None,
                          "", model.query - query_times, example_end_time, "0")
